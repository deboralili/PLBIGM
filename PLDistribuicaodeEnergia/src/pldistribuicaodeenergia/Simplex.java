...
public class Simplex {
    ...
    public void construir() {
        ...
        int a = 0;
        for (int j = 0; j < this.z.size() - 1; j++) {
            int aa = a;

            a = 0;
            for (int i = 0; i < this.b.size(); i++) {

                if (this.quadro.get(i).get(j) == 0) {
                    a++;
                }
...
//
//        /*
//         Inicialmente as linhas das variáveis básicas conterão as informações
//         das variáveis artificiais.
//                
//         */
//        //Percorre a linha de variaveis Basicas
//        for (int i = 0; i < this.basica.size(); i++) { //Definir linha para cada variavel basica
//
//            ArrayList<Integer> linha = new ArrayList<Integer>();
//
//            //Percorre a coluna do cabeçalho
//            for (int j = 0; j < this.cabecalho.size(); j++) {
//
//                //A variavél basica é ARTIFICIAL?
//                if (this.listaArtificiais.contains(this.basica.get(i))) {
//
//                    //A variavel do cabeçalho é de CUSTO?
//                    if (this.listaVariaveisCusto.contains(this.cabecalho.get(j))) {
//
//                        //quando as primeiras 9 variaveis artificiais cruzarem com as respectivas ofertas (1)
//                        //A variavel Basica é a1?
//                        if (this.basica.get(i) == this.listaArtificiais.get(0)) {
//
//                            //A variavel do cabeçalho é o ofertante1?
//                            if (this.cabecalho.get(j).getIDofer() == "1") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a2?
//                        if (this.basica.get(i) == this.listaArtificiais.get(1)) {
//
//                            //A variavel do cabeçalho é o ofertante2?
//                            if (this.cabecalho.get(j).getIDofer() == "2") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a3?
//                        if (this.basica.get(i) == this.listaArtificiais.get(2)) {
//
//                            //A variavel do cabeçalho é o ofertante3?
//                            if (this.cabecalho.get(j).getIDofer() == "3") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a4?
//                        if (this.basica.get(i) == this.listaArtificiais.get(3)) {
//
//                            //A variavel do cabeçalho é o ofertante4?
//                            if (this.cabecalho.get(j).getIDofer() == "4") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a5?
//                        if (this.basica.get(i) == this.listaArtificiais.get(4)) {
//
//                            //A variavel do cabeçalho é o ofertante5?
//                            if (this.cabecalho.get(j).getIDofer() == "5") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a6?
//                        if (this.basica.get(i) == this.listaArtificiais.get(5)) {
//
//                            //A variavel do cabeçalho é o ofertante6?
//                            if (this.cabecalho.get(j).getIDofer() == "6") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a7?
//                        if (this.basica.get(i) == this.listaArtificiais.get(6)) {
//
//                            //A variavel do cabeçalho é o ofertante7?
//                            if (this.cabecalho.get(j).getIDofer() == "7") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a8?
//                        if (this.basica.get(i) == this.listaArtificiais.get(7)) {
//
//                            //A variavel do cabeçalho é o ofertante8?
//                            if (this.cabecalho.get(j).getIDofer() == "8") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a9?
//                        if (this.basica.get(i) == this.listaArtificiais.get(8)) {
//
//                            //A variavel do cabeçalho é o ofertante9?
//                            if (this.cabecalho.get(j).getIDofer() == "9") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //quando as ultimas 12 variaveis artificiais cruzarem com as respectivas empresas (1)
//                        //A variavel Basica é a10?
//                        if (this.basica.get(i) == this.listaArtificiais.get(9)) {
//
//                            //A variavel do cabeçalho é a empresa1?
//                            if (this.cabecalho.get(j).getIDemp() == "1") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a11?
//                        if (this.basica.get(i) == this.listaArtificiais.get(10)) {
//
//                            //A variavel do cabeçalho é a empresa2?
//                            if (this.cabecalho.get(j).getIDemp() == "2") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a12?
//                        if (this.basica.get(i) == this.listaArtificiais.get(11)) {
//
//                            //A variavel do cabeçalho é a empresa3?
//                            if (this.cabecalho.get(j).getIDemp() == "3") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a13?
//                        if (this.basica.get(i) == this.listaArtificiais.get(12)) {
//
//                            //A variavel do cabeçalho é a empresa4?
//                            if (this.cabecalho.get(j).getIDemp() == "4") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a14?
//                        if (this.basica.get(i) == this.listaArtificiais.get(13)) {
//
//                            //A variavel do cabeçalho é a empresa5?
//                            if (this.cabecalho.get(j).getIDemp() == "5") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a15?
//                        if (this.basica.get(i) == this.listaArtificiais.get(14)) {
//
//                            //A variavel do cabeçalho é a empresa6?
//                            if (this.cabecalho.get(j).getIDemp() == "6") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a16?
//                        if (this.basica.get(i) == this.listaArtificiais.get(15)) {
//
//                            //A variavel do cabeçalho é a empresa7?
//                            if (this.cabecalho.get(j).getIDemp() == "7") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a17?
//                        if (this.basica.get(i) == this.listaArtificiais.get(16)) {
//
//                            //A variavel do cabeçalho é a empresa8?
//                            if (this.cabecalho.get(j).getIDemp() == "8") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a18?
//                        if (this.basica.get(i) == this.listaArtificiais.get(17)) {
//
//                            //A variavel do cabeçalho é a empresa9?
//                            if (this.cabecalho.get(j).getIDemp() == "9") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a19?
//                        if (this.basica.get(i) == this.listaArtificiais.get(18)) {
//
//                            //A variavel do cabeçalho é a empresa10?
//                            if (this.cabecalho.get(j).getIDemp() == "10") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a20?
//                        if (this.basica.get(i) == this.listaArtificiais.get(19)) {
//
//                            //A variavel do cabeçalho é a empresa11?
//                            if (this.cabecalho.get(j).getIDemp() == "11") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                        }
//
//                        //A variavel Basica é a21?
//                        if (this.basica.get(i) == this.listaArtificiais.get(20)) {
//
//                            //A variavel do cabeçalho é a empresa12?
//                            if (this.cabecalho.get(j).getIDemp() == "12") {
//                                linha.add(1);
//                            } else {
//                                linha.add(0);
//                            }
...
//                    }
//
//                    //A variavel do cabeçalho é artificial?
//                    if (this.listaArtificiais.contains(this.cabecalho.get(j))) {
//
//                        //Quando houver uma interseção entre as variaveis artificiais (quadro identidade)
//                        //A variavel basica é igual a variavel do cabeçalho?
//                        if (this.basica.get(i).getIDofer() == this.cabecalho.get(j).getIDofer()) {
//                            linha.add(1);
//                        } else {
//                            linha.add(0);
//                        }
